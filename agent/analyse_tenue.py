# ============================================================
# agent/analyse_tenue.py
# ============================================================
# RÔLE : Analyse une photo de tenue complète via LLM vision (Groq
#        + Llama 4 Scout) et identifie chaque vêtement visible.
#
# DESCRIPTION :
#   Envoie la photo à Groq Vision avec un prompt détaillé qui
#   demande d'inspecter chaque zone du corps (tête, buste, taille,
#   bas, poignets, pieds...) et de renvoyer pour chaque pièce son
#   type, sa couleur, ses saisons et sa marque, ainsi que le style
#   global et les occasions adaptées. Le résultat est ensuite
#   filtré/validé (types/saisons/styles/occasions autorisés).
#
#   Usage :
...
#   - analyser_tenue(source)     : appelle Groq Vision et renvoie {vetements, style_global, occasions}
#
# DÉPENDANCES :
#   - groq (Groq), requests, dotenv (.env -> GROQ_API_KEY)
#
# APPELS ENTRANTS :
#   - Backend/main.py (route /api/analyse-tenue)
#
# APPELS SORTANTS :
...
# Convertit une image (fichier local ou URL) en base64. Retourne (base64, media_type).
