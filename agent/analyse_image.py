# ============================================================
# agent/analyse_image.py
# ============================================================
# RÔLE : Analyse une image de vêtement via LLM vision (Groq +
#        Llama 4 Scout) pour en extraire couleur, saisons et marque.
#
# DESCRIPTION :
#   Convertit une image (fichier local ou URL) en base64, envoie
#   un prompt à Groq Vision en demandant une réponse JSON
#   structurée, puis nettoie/valide cette réponse (filtre les
#   saisons invalides, ignore la marque si la confiance est
#   faible). Le paramètre optionnel type_vetement permet de
#   guider le LLM sur la pièce à analyser lorsque plusieurs
#   vêtements sont visibles sur la photo.
#
#   Usage :
...
#   - _image_to_base64(source)        : convertit une image (fichier/URL) en base64 + media type
#   - analyser_image(source, type_vetement) : appelle Groq Vision et renvoie {couleur, couleurs_secondaires, saisons, marque, confidence_marque}
#
# DÉPENDANCES :
#   - groq (Groq), requests, dotenv (.env -> GROQ_API_KEY)
#
# APPELS ENTRANTS :
#   - scripts/analyse_couleur.py (wrapper CLI appelé par server.js)
#
# APPELS SORTANTS :
#   - API Groq (chat.completions, modèle meta-llama/llama-4-scout-17b-16e-instruct)
#   - requests.get() si la source est une URL
# ============================================================
